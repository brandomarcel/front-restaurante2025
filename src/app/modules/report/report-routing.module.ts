...
const routes: Routes = [
  ...
  { path: 'report-cierre-caja', component: ReportCierreCajaComponent, canActivate: [RoleAccessGuard], data: { requiredFeatures: ['restaurant', 'restaurant_pos', 'cash_register'], anyPermissionKeys: ['restaurant.manage'] } },
